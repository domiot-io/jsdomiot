...
export class DOMIoT {
    ...
    constructor(html, elementFactoryCollection) {
        ...
        for (const el of elsWithBinding) {
            ...
            splittedBinding.forEach((idAndIndex) => {
                ...
                if (bindingEl.elementsWithoutIndex) {
                    ...
                    console.log(`1 Adding element ${el.id} to binding ${bindingEl.id} with index ${bindingEl.lastIndex}.`);
                ...
                if (index != null) {
                    ...
                    console.log(`2 Adding element ${el.id} to binding ${bindingEl.id} with index ${index}.`);
                    ...
                    for (const [_index, _el] of bindingEl.tmpElements) {
                        bindingEl.lastIndex = bindingEl.lastIndex + 1;
                        console.log(`3 Adding element ${_el.id} to binding ${bindingEl.id} with index ${bindingEl.lastIndex}.`);
                    ...
                    bindingEl.lastIndex = bindingEl.lastIndex + 1;
                    console.log(`4 Adding element ${el.id} to binding ${bindingEl.id} with index ${bindingEl.lastIndex}.`);
                    bindingEl.elementsWithoutIndex.set(bindingEl.lastIndex, el);
                }
        ...
        for (const id in bindingEls) {
            ...
            console.log('[INFO] dispatching load event to binding', bindingEl.id);
     ...
     * @private
     */
    _getBindingAndIndex(idAndIndex) {
    ...
    _setBindingHooks(window) {
        ...
        window.Element.prototype.removeAttribute = function(namespace, attributeName) {
