...
export class DOMIoT {
    ...
    _setBindingHooks(window) {
        ...
        window.Element.prototype.setAttribute = function(attributeName, attributeValue) {
            const res = originalSetAttribute.call(this, attributeName, attributeValue);
            scope._notifyAttributeModificationToBinding(this, attributeName, attributeValue);
            return res;
        };
        ...
        window.Element.prototype.removeAttribute = function(attributeName) {
            const res = originalRemoveAttribute.call(this, attributeName);
        ...
        window.Element.prototype.setAttributeNS = function(namespace, attributeName, attributeValue) {
            const res = originalSetAttributeNS.call(this, namespace, attributeName, attributeValue);
            scope._notifyAttributeNSModificationToBinding(this, namespace, attributeName, attributeValue);
            return res;
        };
        ...
        window.Element.prototype.removeAttributeNS = function(namespace, attributeName) {
            const res = originalRemoveAttributeNS.call(this, namespace, attributeName);
